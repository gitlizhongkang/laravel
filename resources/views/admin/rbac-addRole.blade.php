...
@section('content')
    ...
    <div class="page-container">
        <form action="{{url('/admin-rbac-addRole')}}" method="post" class="form form-horizontal" id="form-article-add">
            {{csrf_field()}}
            <div class="row cl">
            ...
            <div class="row cl">
                <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                    <input type="submit" value="创建角色" class="btn btn-secondary radius">
                </div>
            </div>
        </form>
    </div>
