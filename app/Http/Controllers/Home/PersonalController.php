...
class PersonalController extends Controller
{
    ...
    public function userInfo(){
        ...
        $uid = 1;
        //查询用户信息
        $userInfo = $this->curl('http://www.xuko.com/one/laravel/public/home-personal-getUserInfo', "uid=$uid", true);
...
//        $uid = Session::get('uid');//session内拿用户uid
        $uid = 1;
        //查询订单
        $userOrder = $this->curl('http://www.xuko.com/one/laravel/public/home-personal-getUserOrder', "uid=$uid", true);
...
//        $uid = Session::get('uid');//session内拿用户uid
        $uid = 1;
        //查询订单
        $userOrder = $this->curl('http://www.xuko.com/one/laravel/public/home-personal-getUserOrder', "order_id=$order_id&uid=$uid", true);
        $data['userOrder'] = json_decode($userOrder,true);
        //查询订单详情
        $orderGoods = $this->curl('http://www.xuko.com/one/laravel/public/home-personal-getOrderGoods', "order_id=".$order_id, true);
...
//        $uid = Session::get('uid');//session内拿用户uid
        $uid = 1;
        //查询用户收货地址信息
        $userAddress = $this->curl('http://www.xuko.com/one/laravel/public/home-personal-getUserAddress', "uid=$uid", true);
